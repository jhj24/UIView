...
import kotlinx.android.synthetic.main.fragment_view_ring_chart.view.*

/**
 * Created by jhj on 19-1-7.
 */
class RingChartFragment : Fragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_view_ring_chart, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.ringChartView.setDataList(list)
    }
}